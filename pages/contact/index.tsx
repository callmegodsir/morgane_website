    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="py-16 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Membre Anacofi <br /> - ORIAS : 23008521 <br />- CIF : E010620{" "}
                <br />- Carte T : CPI75012022000000045
              </p>
            </div>
          ...
          {/* Colonne de droite - MPV INVEST et Réseaux sociaux */}
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-semibold mb-6">MPV INVEST</h3>
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <a
                    ...
                    className="flex items-center hover:text-blue-600 mb-4"
                  >
                    <span className="material-icons-outlined mr-2">📧</span>
            ...
            <div>
              ...
              <div className="flex flex-col space-y-4">
                <Link
                  ...
                  className="bg-blue-100 px-6 py-4 rounded-lg hover:bg-blue-200 flex items-center gap-3 transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg
                ...
                <Link
                  ...
                  className="bg-pink-100 px-6 py-4 rounded-lg hover:bg-pink-200 flex items-center gap-3 transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg
                    className="w-8 h-8 fill-current text-pink-600"
                    viewBox="0 0 24 24"
                  >
